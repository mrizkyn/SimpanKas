                ...
                <div class="table-responsive nowrap" style="width:100%;" id="reportTable">
                    ...
                    <table id="accountsTable" class="table " style="font-size: 12px;">
                        ...
                        @endforeach
                            ...
                            @foreach ($accumulatedData as $item)
                                <tr>
                                    <td  style="background-color: rgb(92, 214, 255);">{{ $item->account_name }}</td>
                                    <td  style="background-color: rgb(92, 214, 255);" class="text-right">{{ 'Rp ' . number_format($item->total_exp, 0, ',', '.') }}</td>
                                </tr>
                            @endforeach
                            <tr>
