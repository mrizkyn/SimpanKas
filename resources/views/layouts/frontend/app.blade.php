...
<body>
    ...
    <header id="header" class="header d-flex align-items-center">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
            <a href="/financial" class="logo d-flex align-items-center">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    <li><a href="/financial">Beranda</a></li>
                    ...
                    {{-- <li class="dropdown"><a href="#"><span>Laporan</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            <li><a href="/financial/income-statement">Laba Rugi</a></li>
                            <li><a href="/financial/financial-position">Posisi Keuangan</a></li>
                            <li><a href="/financial/financial-note">CaLK</a></li>
                        </ul>
                    </li> --}}
